...
export function NameDialog({ title, initial = '', onSave, onClose }: Props) {
  ...
  return (
    ...
    >
      <div
        className="flex w-full max-w-sm max-h-[90vh] flex-col overflow-hidden rounded-[1.75rem] border border-white bg-white p-7 shadow-2xl"
      ...
      >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto pr-1 pt-2">
          <input
            ...
            className="w-full rounded-2xl border border-orange-100 bg-orange-50/50 px-4 py-3 outline-none transition focus:border-orange-300 focus:bg-white focus:ring-4 focus:ring-orange-100"
          />
        </div>
        <div className="shrink-0 flex justify-end gap-2 pt-3">
          <button
            onClick={onClose}
